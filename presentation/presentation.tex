...
\begin{frame}{Artificial atoms \hfill{\small[arXiv:cond-mat/0703002]}}
  \begin{columns}
    ...
    \begin{column}{0.6\textwidth}
      \centering
      \onslide<1->\includegraphics[width=0.5\textwidth]{figures/cryostat.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[t,fragile]{Randomized Benchmarking \hfill{\small[arXiv:0707.0963v1]}}
  ...
  \vspace{3mm}
  \onslide<2->{Randomized Benchmarking protocol:
...
\begin{frame}{Flux pulse reconstruction \hfill{\tiny{arXiv:1907.04818}}}
  \begin{columns}
    ...
    \begin{column}{0.6\textwidth}
      \begin{figure}
        \centering
        \onslide<1->\includegraphics[width=0.85\textwidth]{figures/cryoscope_pulse.png}\\
        \vspace{3em}
        \onslide<2->\includegraphics[width=0.85\textwidth]{figures/BlochEvolution.png}\\
        \onslide<2->{\tiny DOI: 10.1039/D2TC01258H}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
