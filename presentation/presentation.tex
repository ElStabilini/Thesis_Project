...
\begin{frame}{DRAG pulse}
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.5\textwidth}
      \includegraphics[width=0.55\textwidth]{figures/DRAG.png}\\
      {\tiny ISBN: 9780198787488}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Virtual-Z}
  \begin{itemize}
    ...
    \item<2-> Physically, it shifts the phase between the $\ket{0}$ and $\ket{1}$ states: $R_z(\theta)\ket{0} = \ket{0} \; R_z(\theta)\ket{1} = e^{-i\theta}\ket{1}$
