...
As explained in section \ref{sec:flux_tunable_transmon} it is suggested to work at the qubit sweetspot, where the qubit frequency is less sensitive to magnetic flux fluctuations.
...
After defining all the readout parameters, it is necessary to calibrate the parameters of the drive pulses that constitutes the native gates of the quantum computer.
With Rabi experiments is possibile to calibrate the drive pulses to perform precise rotations on the Bloch sphere within approximately $40$ ns \cite{Rabi1936}, \cite{Wallraff2005}.

\subsubsection{Rabi amplitude-frequency}
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/png/rabi_af.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/png/rabi_amp.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/png/rabi_length.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/png/ramsey.png}
