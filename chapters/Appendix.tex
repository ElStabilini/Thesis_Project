...
\begin{figure}[h!]
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        ...
        \caption{PPlot of the avarge Clifford gate fidielity as a function of the function evauluations. First optimization attempt with Nelder-Mead algorithm.}
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        ...
        \caption{PPlot of the avarge Clifford gate fidielity as a function of the function evauluations.\\
