...
\paragraph{Randomized Benchmarking evaluation}

In the results presented below, I employed the randomized benchmarking (RB) routine implemented in \Qibocal, an example of which is shown in Section \ref{sec:RB_calibration}. 
