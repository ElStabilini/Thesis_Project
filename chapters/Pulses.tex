...
This assumption implies a perfectly linear response of the qubit to the drive pulse, which may not be satisfied in practice due to nonlinearities in the system or imperfections in the pulse generation and delivery.
...
In particolare ho modificato il codice per le diverse varianti del protocollo per osservare le oscillazioni di Rabi. 
