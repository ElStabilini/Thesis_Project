...
\paragraph{Phase reconstruction}
Dopo aver costruito la pulse sequence, sia quella che si conclude con $R_X(\pi/2)$ per misurare $\langle Y \rangle$ e $R_Y(\pi/2)$ per misurare $\langle X \rangle$, questi dati vengono combinato per ottenere $\varphi_\tau$


%mostro come vengono processati i dati per ottenere la fase
Per processare i dati e ricostruire la fase prima e l'impulso di flusso dopo

\subsubsection{Flux pulse reconstruction}
According to quello che ho spiegato prima 
