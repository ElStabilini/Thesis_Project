...
%TOD: guarda correzioni perchè qui ci sono errori un po' grossolani
...
To study the dynamics of the system it is convenient to use the rotating frame, the Hamiltonian becomes: %%add appendix per ricavare hamiltoniana nel rotating frame
\begin{align}
